...
echo_and_run cd "/home/droid/Documentos/EstudosRos/catkin_arthur/src/Rosserial_noetic/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/droid/Documentos/EstudosRos/catkin_arthur/src/Rosserial_noetic/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/droid/Documentos/EstudosRos/catkin_arthur/build/Rosserial_noetic/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
