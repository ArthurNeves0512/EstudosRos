...
echo_and_run cd "/home/droid/Documentos/EstudosRos/catkin_arthur/src/Rosserial_noetic/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/droid/Documentos/EstudosRos/catkin_arthur/src/Rosserial_noetic/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/droid/Documentos/EstudosRos/catkin_arthur/build/Rosserial_noetic/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
