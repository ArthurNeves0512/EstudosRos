...
echo_and_run cd "/home/droid/Documentos/EstudosRos/catkin_arthur/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/home/droid/Documentos/EstudosRos/catkin_arthur/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/droid/Documentos/EstudosRos/catkin_arthur/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
