...
echo_and_run cd "/home/droid/Documentos/EstudosRos/catkin_arthur/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/home/droid/Documentos/EstudosRos/catkin_arthur/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/droid/Documentos/EstudosRos/catkin_arthur/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
