...
echo_and_run cd "/home/droid/Documentos/EstudosRos/catkin_arthur/src/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/droid/Documentos/EstudosRos/catkin_arthur/src/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/droid/Documentos/EstudosRos/catkin_arthur/build/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
