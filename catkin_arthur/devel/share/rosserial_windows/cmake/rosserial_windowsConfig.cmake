...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/droid/Documentos/EstudosRos/catkin_arthur/src/rosserial/rosserial_windows)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/droid/Documentos/EstudosRos/catkin_arthur/src/rosserial/rosserial_windows/${idir}'.  ${_report}")
    endif()
